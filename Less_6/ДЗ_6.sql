...
-- доделал в прошлом дз доп задания 4 и 5 https://github.com/pda-gb/DataBases/tree/master/Less_5


-- 1    не упел сделать данное дз. Группировку ещё примерно понял как сделать, как добавить ещё в выборку максимум
